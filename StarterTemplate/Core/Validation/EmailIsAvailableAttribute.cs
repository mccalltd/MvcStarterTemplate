...
namespace StarterTemplate.Core.Validation
{
    ...
    public class EmailIsAvailableAttribute : ValidationAttribute, IClientValidatable
    {
        private const string DefaultErrorMessage = "That email address is already in use.";

        public EmailIsAvailableAttribute()
        {
